...
- **✅ Prompt #1** `character_to_rag_text.txt`: Added graceful missing field handling
...
- **✅ Prompt #11** `location_to_rag_text.txt`: Added support for new location fields
- **✅ Prompt #12** `lore_item_to_rag_text.txt`: Added support for related elements field
...
- `app/prompts/system/character_to_rag_text.txt`
...
- `app/prompts/system/location_to_rag_text.txt`
- `app/prompts/system/lore_item_to_rag_text.txt`
