...
providers = [
    ...
    {"provider_key": "nature_scene", "label": "Nature Scene", "icon": "🌿", "category": "memory", "enabled": True, "display_order": 14, "patient_visible": True, "family_visible": True, "source_app": "daily_newsletter"},
