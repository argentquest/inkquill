...
graph TB
    ...
    subgraph "Processing Layer"
        ...
        BACKGROUND_PROC[Background Processing<br/>- Context indexing<br/>- Image processing<br/>- Analytics]
    end
    
    subgraph "Storage Layer"
        POSTGRES[PostgreSQL<br/>- Structured data<br/>- Relationships<br/>- Transactions]
        SEARCH_INDEX[AI Search Index<br/>- Vector embeddings<br/>- Full-text search<br/>- Context content]
        BLOB_STOContextE[Blob Storage<br/>- Files<br/>- Images<br/>- Generated content]
    end
    ...
    BACKGROUND_PROC --> BLOB_STOContextE
    
    POSTGRES --> API_RESPONSES
    SEARCH_INDEX --> API_RESPONSES
    BLOB_STOContextE --> GENERATED_FILES
    POSTGRES --> ANALYTICS
    ...
    class POSTGRES,SEARCH_INDEX,BLOB_STOContextE storage
...
```python
async def update_character_with_context_indexing(
    db: AsyncSession,
    character_id: int,
    character_update: CharacterUpdate,
    background_tasks: BackgroundTasks
) -> Character:
    """Update character and schedule Context re-indexing."""
