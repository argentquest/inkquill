...
You would use the schema we defined previously (in the document &lt;doc id="azure_ai_search_schema_v1">Azure AI Search: Index Schema for RAG&lt;/doc>) to create this index. You can do this through:
The Azure Portal.
...
Okay, I will provide the schema for the Azure AI Search index again. This outlines the fields, their types, and configurations for your RAG system.

Azure AI Search: Index Schema for RAG Content
Objective:
This schema defines the structure for the Azure AI Search index that will store processed document chunks and their vector embeddings. This index is the backbone of the Retrieval Augmented Generation (RAG) system, enabling efficient search and retrieval of relevant context to augment Large Language Model (LLM) prompts.
...
Description: ID of the user who uploaded the document (for per-user RAG).
source_filename
Data Type (Edm): Edm.String
