...
*   **Purpose:** Tracks user-uploaded files and system-generated RAG documents.
...
*   **`document_status_enum`**: UPLOADED, PENDING, PROCESSING_TEXT, CHUNKING, GENERATING_EMBEDDINGS, INDEXING, COMPLETED, ERROR
...
*   **`job_type_enum` (New)**: WORLD_EXTRACTION_FROM_DOC, DOCUMENT_RAG_PROCESSING, WORLD_IMPORT_FROM_TITLE
