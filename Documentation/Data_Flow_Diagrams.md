...
graph TD
    ...
    subgraph Backend (FastAPI Application)
        ...
        M --> O(RAG Retrieval: Semantic Kernel Plugin)
        ...
        O --> T(Prepare LLM Prompt: System + Context + RAG + Instruction)
