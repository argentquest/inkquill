...
- **Context Integration**: Automatic inclusion of world element summaries + RAG content
    ...
    async def build_context_prompt(self, world_id: int, db: AsyncSession) -> str:
        ...
        context_parts = [
            ...
            *[f"- {lore.title}: {lore.description}" for lore in world.lore_items],
            "",
            "RAG CONTEXT:",
            await self.get_rag_context(world_id),
            "",
...
- **RAG Optimization**: Efficient retrieval of relevant world content
