-- Sample Blog Data Creation Script (Fixed Enum Values)
-- Run this to create test blog posts and comments

-- First, check if we have users and get user ID
DO $$
DECLARE
    user_count INTEGER;
...
BEGIN
    ...
    INSERT INTO blog_posts (
        ...
        'Welcome to Our Blog',
        'welcome-to-our-blog',
        '<h2>Welcome to Our Blog!</h2><p>This is a sample blog post to test the commenting functionality. We''re excited to share our thoughts and hear from you in the comments below.</p><p>Feel free to leave a comment and start a discussion!</p><h3>What You Can Expect</h3><ul><li>Regular updates on exciting topics</li><li>Interactive discussions in the comments</li><li>Community-driven content</li></ul>',
    ...
    INSERT INTO blog_comments (
        ...
        'APPROVED', 
        5, 
        0,  -- Will update after creating reply
        false, 
    ...
    -- Update reply count for comment 1
    UPDATE blog_comments SET reply_count = 1 WHERE id = comment1_id;
