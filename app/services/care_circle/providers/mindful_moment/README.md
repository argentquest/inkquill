# Mindful Moment Provider

## Purpose
Generates a short seated mindfulness or breathing exercise, with a curated fallback pool.

## Runtime Contract
- Provider key: `mindful_moment`
...
- Add response-shape validation and a maximum instruction length before returning LLM content.
- Consider sourcing exercise type from patient mobility or sensory preferences so the generated exercise feels more personalized.
