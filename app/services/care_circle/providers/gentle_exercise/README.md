...
## Purpose
Simple seated exercises for gentle movement.

## Runtime Contract
- Provider key: `gentle_exercise`
...
- Provider config keys read: `exercises`
...
## Output Shape
- Observed payload fields returned by the provider: `duration_note`, `instruction`, `title`
