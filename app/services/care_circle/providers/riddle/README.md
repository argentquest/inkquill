# Daily Riddle Provider

## Purpose
Fun riddles with answers to ponder.
...
## Output Shape
- Observed payload fields returned by the provider: `answer`, `question`
...
- Validate the JSON response shape and enforce maximum answer/question length before rendering.
- If the difficulty config is intentional, wire it into riddle style selection or reveal behavior; it is not used today.
