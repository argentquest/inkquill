# Furry Friend Provider

## Purpose
A cheerful dog photo to brighten your day.

## Runtime Contract
- Provider key: `dog_photo`
...
- Provider config keys read: `api_url`, `default_caption`
...
## Output Shape
- Observed payload fields returned by the provider: `breed`, `caption`, `image_url`
