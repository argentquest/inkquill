...
## Purpose
A warm note from a loved one, just for you.

## Runtime Contract
- Provider key: `family_greeting`
...
- Patient preference keys read: `family_members`, `favourite_foods`, `hometown`, `life_roles`, `pets`
...
## Output Shape
- Observed payload fields returned by the provider: `message`, `sender`
